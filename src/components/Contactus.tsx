      ...
      <section className="canva" style={{width: '100%'    , backgroundColor: 'white', zIndex: '10'}}>
        ...
        <div style="background-color: lightgrey;">
          <div style="background-color: lightgrey;">
            ...
            <div className="container-fluid" style="padding: 5vh; margin-top:13vh; background-color: lightgrey;">
              <div className="row" style="background-color: #FF91A4; background-repeat: no-repeat; background-size: cover; color: white; height: vh; border-radius: 20px;">
                <div className="col-sm" style="padding: 30px;">

                  <form action="https://api.web3forms.com/submit" method="POST">
                    <input type="hidden" name="access_key" value="5183f124-530a-47a9-aa6a-fa25a8a98ba7">
                      <div className="form-group">
                        <label for="Name1">Name</label>
                        <input type="text" className="form-control" id="Name1" name="name" aria-describedby="emailHelp" placeholder="Enter Name">
                      </div>
                      <div className="form-group">
                        <label for="">Email</label>
                        <input type="email" className="form-control" name="email" required placeholder="Enter Mail Adress">
                          <small id="emailHelp" className="form-text text-muted">We'll never share your email with anyone else.</small>
                      </div>
                      <div className="form-group">
                        <label for="Message1">Message</label>
                        <textarea name="message" required className="form-control" id="Message1" placeholder="Message"></textarea>
                      </div>
                      <br>
                    ...
                    <div className="col-sm" style="padding: 40px;">
                      ...
                      <p className="text-justify">
                        <b>THANK YOU FOR YOUR INTEREST IN Kanha Makeup Studio        </b>   <br>
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3408.364810119334!2d75.6162147756036!3d31.32129667430578!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMzHCsDE5JzE2LjciTiA3NcKwMzcnMDcuNiJF!5e0!3m2!1sen!2sin!4v1724761429678!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        ...
                        <footer className="bg-dark text-center text-white">
                            ...
                            <div className="row text-center">
                              ...
                              <div className="col-lg-4 mb-4">
                                ...
                                <ul className="list-unstyled">
                                  ...
                                  <li className="mb-2">
                                    <a href="academy.html" className="text-white text-decoration-none">Academy</a>
                                  </li>
                                  <li className="mb-2">
                                    <a href="aboutus.html" className="text-white text-decoration-none">About Us</a>
                                  </li>
                                  <li className="mb-2">
                                    <a href="contactus.html" className="text-white text-decoration-none">Contact Us</a>
                                  </li>
                                </ul>
                              </div>
                              ...
                              <div className="col-lg-4 mb-4">
                                ...
                                <div className="d-flex align-items-center justify-content-center mb-3">
                                  <img src="images/phone-removebg-preview.png" alt="Phone" style="height: 20px; margin-right: 15px;">
                                    <a href="tel:9646486969" className="text-white text-decoration-none" style="font-size: 16px;">9646486969</a>
                                </div>
                                <div className="d-flex align-items-center justify-content-center">
                                  <img src="images/email2.jpg" alt="Email" style="height: 30px; margin-right: 15px;">
                                    <a href="mailto:madhvimanchanda92@gmail.com" className="text-white text-decoration-none" style="font-size: 16px;">madhvimanchanda92@gmail.com</a>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <!-- Footer Bottom -->
                          <div className="text-center py-3" style="background-color: rgba(0, 0, 0, 0.2); font-size: 14px;">
